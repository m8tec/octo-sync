    ...
    ILogger<NavidromePlaylistImageClient> logger)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var uploadResponse = await SendNativeImageUploadAsync(httpClient, uploadUrl, imageData, contentType, token, cancellationToken);
        if (uploadResponse.StatusCode == System.Net.HttpStatusCode.Unauthorized)
        {
            ...
            uploadResponse.Dispose();
            uploadResponse = await SendNativeImageUploadAsync(httpClient, uploadUrl, imageData, contentType, token, cancellationToken);
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        content.Add(imageContent, "image", "playlist.jpg");
